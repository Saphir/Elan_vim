...
# Public bin
bashrc_emc='/c4site/SOBO/Public/zhengh3/.bashrc_emc'
[ -e "$bashrc_emc" ] && source ${bashrc_emc}

real_zshrc=$(readlink -m ~/.zshrc)
[[ -e ${real_zshrc%/*}/bashrc_function ]] && source ${real_zshrc%/*}/bashrc_function
[[ -e ${real_zshrc%/*}/bashrc_expand ]] && source ${real_zshrc%/*}/bashrc_expand
